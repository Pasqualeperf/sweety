<x-app-layout>
    ...
    <div class="lg:flex lg:justify-between max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div class="lg:flex-1 lg:mx-10" style="max-width: 700px">
            <form method="POST" action="{{route('update-profile', $user->slug)}}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                ...
                <div class="mb-6">
                    ...
                    <a href="{{ $user->toProfile() }}" class="hover:underline">Cancel</a>
                </div>
            </form>
        </div>
