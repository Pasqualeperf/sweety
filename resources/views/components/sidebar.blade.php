<ul>
    ...
    <li><a class="font-bold text-lg mb-4 block" href="{{route('community')}}">Community</a></li>
    ...
    <li><a class="font-bold text-lg mb-4 block" href="{{auth()->user()->toProfile()}}">Profile</a></li>
